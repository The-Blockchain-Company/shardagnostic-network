...
\miniEntry
    ...
    {https://The-Blockchain-Company.github.io/shardagnostic-network/typed-protocols-examples/Network-TypedProtocol-PingPong-Type.html\#t:PingPong}
...
\miniEntry
    ...
    {https://The-Blockchain-Company.github.io/shardagnostic-network/typed-protocols-examples/Network-TypedProtocol-ReqResp-Type.html\#t:ReqResp}

\miniEntry
    {Handshake Mini Protocol}
    {handshake-protocol}
    {This protocol is used for version negotiation.}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/Handshake/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network-framework/Shardagnostic-Network-Protocol-Handshake-Type.html\#t:Handshake}

\miniEntry
    {Chain Synchronisation Protocol}
    {chain-sync-protocol}
    {The protocol by which a downstream chain consumer follows an upstream chain producer.}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/ChainSync/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-ChainSync-Type.html\#t:ChainSync}

\miniEntry
    {Block Fetch Protocol}
    {block-fetch-protocol}
    {The block fetching mechanism enables a node to download ranges of blocks.}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/BlockFetch/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-BlockFetch-Type.html\#t:BlockFetch}

\miniEntry
    {Transaction Submission Protocol v2}
    {tx-submission-protocol2}
    {A Protocol for transmitting transaction between core nodes.}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/TxSubmission2/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-TxSubmission2-Type.html\#t:TxSubmission2}

\miniEntry
    {Keep Alive Protocol}
    {keep-alive-protocol}
    {A protocol for sending keep alive messages and round trip measurments}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/KeepAlive/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-KeepAlive-Type.html\#t:KeepAlive}
...
\miniEntry
    ...
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/LocalTxSubmission/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-LocalTxSubmission-Type.html\#t:LocalTxSubmission}

\miniEntry
    {Locat State Query Mini Protocol}
    {local-state-query-protocol}
    {Protocol used by local clients to query ledger state}
    {shardagnostic-network/src/Shardagnostic/Network/Protocol/LocalStateQuery/Type.hs}
    {https://The-Blockchain-Company.github.io/shardagnostic-network/shardagnostic-network/Shardagnostic-Network-Protocol-LocalStateQuery-Type.html\#t:LocalStateQuery}
...
\haddockref{Shardagnostic.Network.Protocol.Handshake.Type}{shardagnostic-network-framework/Shardagnostic-Network-Protocol-Handshake-Type\#t:Handshake}
...
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/handshake-node-to-node.cddl}
\subsubsection{Node to client handshake mini-protocol}
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/handshake-node-to-client.cddl}

\section{Chain-Sync mini-protocol}
\label{chain-sync-protocol}
\haddockref{Shardagnostic.Network.Protocol.ChainSync.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-ChainSync-Type\#t:ChainSync}
...
Maximum depth of a fork in Shardagnostic is bounded and the intersection will always be found with a small number of
...
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/chain-sync.cddl}
See appendix \ref{cddl-common} for common definitions.

\section{Block-Fetch mini-protocol}
\label{block-fetch-protocol}
\haddockref{Shardagnostic.Network.Protocol.BlockFetch.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-BlockFetch-Type\#t:BlockFetch}
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/block-fetch.cddl}
See appendix \ref{cddl-common} for common definitions.

\section{Tx-Submission mini-protocol}
\subsection{Version 1}
\haddockref{Shardagnostic.Network.Protocol.TxSubmission.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-TxSubmission-Type\#t:TxSubmission}
...
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/tx-submission.cddl}
See appendix \ref{cddl-common} for common definitions.

\subsection{Version 2}
\haddockref{Shardagnostic.Network.Protocol.TxSubmission2.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-TxSubmission2-Type\#t:TxSubmission2}
...
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/tx-submission2.cddl}
...
\haddockref{Shardagnostic.Network.Protocol.KeepAlive.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-KeepAlive-Type\#t:KeepAlive}
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/keep-alive.cddl}

\section{Local Tx-Submission mini-protocol}
\haddockref{Shardagnostic.Network.Protocol.LocalTxSubmission.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-LocalTxSubmission-Type\#t:LocalTxSubmission}
...
\haddockref{Shardagnostic.Network.Protocol.LocalStateQuery.Type}{shardagnostic-network/Shardagnostic-Network-Protocol-LocalStateQuery-Type\#t:LocalStateQuery}
...
(Cole, Shelly, etc) and are not specified in this document.  The protocol
...
\subsection{CDDL encoding specification}
\lstinputlisting[style=cddl]{../../shardagnostic-network/test-cddl/specs/local-state-query.cddl}
See appendix \ref{cddl-common} for common definitions.
...
\haddockref{Shardagnostic.Network.NodeToNode}{shardagnostic-network/Shardagnostic-Network-NodeToNode}\newline
\haddockref{Shardagnostic.Network.NodeToNode.Version}{shardagnostic-network/Shardagnostic-Network-NodeToNode-Version}\newline
...
\haddockref{Shardagnostic.Network.NodeToClient}{shardagnostic-network/Shardagnostic-Network-NodeToClient}\newline
\haddockref{Shardagnostic.Network.NodeToClient.Version}{shardagnostic-network/Shardagnostic-Network-NodeToClient-Version}\newline
...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{l|l}
      ...
      $NodeToClientV\_5$ & evie \\\hline
      $NodeToClientV\_6$ & jen \\\hline
