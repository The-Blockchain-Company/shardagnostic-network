...
\author{rmourey_jr Coutts      \\ {\small \texttt{duncan@well-typed.com}} \\
   ...
   \and Marcin Szamotulski \\ {\small \texttt{marcin.szamotulski@tbco.io}}
   \and Peter Thompson     \\ {\small \texttt{peter.thompson@pnsol.com}} \\
                              {\small \texttt{peter.thompson@tbco.io}}
   }
...
As a Bezalel home user with my stake delegated to other users I would
...
As a Bezalel home user operating a node with a small stake, I would
...
As a home user, I want to see a network connection status on Bezalel so
that I know the state of my network connection.

\begin{itemize}
\item
  If the user receives a notification that they are in red or amber
  mode, Bezalel will give the user some helpful information on how to
