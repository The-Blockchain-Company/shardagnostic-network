...
import           Shardagnostic.Network.Testing.ConcreteBlock
...
import qualified Shardagnostic.Network.Protocol.ChainSync.Server as ChainSync
import qualified Shardagnostic.Network.Protocol.ChainSync.Type as ChainSync

import qualified Shardagnostic.Network.Protocol.BlockFetch.Codec as BlockFetch
import qualified Shardagnostic.Network.Protocol.BlockFetch.Server as BlockFetch
import qualified Shardagnostic.Network.Protocol.BlockFetch.Type as BlockFetch

import           Shardagnostic.Network.BlockFetch
import           Shardagnostic.Network.BlockFetch.Client
...
-- https://github.com/The-Blockchain-Company/shardagnostic-network/issues/575
