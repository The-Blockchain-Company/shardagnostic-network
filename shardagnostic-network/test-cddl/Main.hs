...
import           Shardagnostic.Network.Block (Point, Tip, encodeTip,
                   decodeTip, wrapCBORinCBOR, unwrapCBORinCBOR)
import           Shardagnostic.Network.CodecCBORTerm
import           Shardagnostic.Network.Magic
import           Shardagnostic.Network.Testing.ConcreteBlock (BlockHeader (..), Block)

import           Shardagnostic.Network.Codec
import           Shardagnostic.Network.NodeToNode (NodeToNodeVersion (..),
                   NodeToNodeVersionData (..), nodeToNodeHandshakeCodec)
import           Shardagnostic.Network.NodeToNode.Version (DiffusionMode (..),
                   nodeToNodeCodecCBORTerm)
import           Shardagnostic.Network.NodeToClient (NodeToClientVersion (..),
                   NodeToClientVersionData (..), nodeToClientHandshakeCodec)
import           Shardagnostic.Network.NodeToClient.Version (nodeToClientCodecCBORTerm)
...
import           Shardagnostic.Network.Protocol.ChainSync.Codec (codecChainSync)
import           Shardagnostic.Network.Protocol.ChainSync.Test ()
import           Shardagnostic.Network.Protocol.BlockFetch.Type (BlockFetch)
import qualified Shardagnostic.Network.Protocol.BlockFetch.Type as BlockFetch
import           Shardagnostic.Network.Protocol.BlockFetch.Codec (codecBlockFetch)
import           Shardagnostic.Network.Protocol.BlockFetch.Test ()
import           Shardagnostic.Network.Protocol.Handshake.Type (Handshake)
import qualified Shardagnostic.Network.Protocol.Handshake.Type as Handshake
import           Shardagnostic.Network.Protocol.Handshake.Test (VersionNumber,
                   versionNumberHandshakeCodec)
import           Shardagnostic.Network.Protocol.KeepAlive.Type (KeepAlive)
import qualified Shardagnostic.Network.Protocol.KeepAlive.Type as KeepAlive
import           Shardagnostic.Network.Protocol.KeepAlive.Codec (codecKeepAlive_v2)
import           Shardagnostic.Network.Protocol.KeepAlive.Test ()
import           Shardagnostic.Network.Protocol.TxSubmission.Type (TxSubmission)
import qualified Shardagnostic.Network.Protocol.TxSubmission.Type as TxSubmission
import           Shardagnostic.Network.Protocol.TxSubmission.Codec (codecTxSubmission)
import           Shardagnostic.Network.Protocol.TxSubmission.Test (TxId, Tx)
import           Shardagnostic.Network.Protocol.TxSubmission2.Type (TxSubmission2)
import qualified Shardagnostic.Network.Protocol.TxSubmission2.Type as TxSubmission2
import           Shardagnostic.Network.Protocol.TxSubmission2.Codec (codecTxSubmission2)
import           Shardagnostic.Network.Protocol.TxSubmission2.Test ()
import           Shardagnostic.Network.Protocol.LocalTxSubmission.Type (LocalTxSubmission)
import qualified Shardagnostic.Network.Protocol.LocalTxSubmission.Type as LocalTxSubmission
import           Shardagnostic.Network.Protocol.LocalTxSubmission.Codec (codecLocalTxSubmission)
import qualified Shardagnostic.Network.Protocol.LocalTxSubmission.Test as LocalTxSubmission
...
import qualified Shardagnostic.Network.Protocol.LocalStateQuery.Test as LocalStateQuery
import qualified Shardagnostic.Network.Protocol.Trans.Hello.Type as Hello
...
readCDDLSpecs = do
    dir <- bool (                        "test-cddl" </> "specs") -- False
                ("shardagnostic-network" </> "test-cddl" </> "specs") -- True
       <$> doesDirectoryExist "shardagnostic-network"
