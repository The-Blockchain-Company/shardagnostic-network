...
-- an Shardagnostic protocol) will live in the consensus layer.
module Shardagnostic.Network.Testing.ConcreteBlock (
    Block(..)
  , BlockHeader(..)
  , BlockBody(..)
  , hashHeader
...
import qualified Shardagnostic.Network.MockChain.Chain as C
...
data BlockHeader = BlockHeader {
       ...
       headerSlot     :: SlotNo,                  -- ^ The Shardagnostic time slot index of this block
