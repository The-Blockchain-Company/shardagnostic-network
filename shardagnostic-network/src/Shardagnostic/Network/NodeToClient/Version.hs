...
module Shardagnostic.Network.NodeToClient.Version
  ( NodeToClientVersion (..)
...
import           Shardagnostic.Network.Protocol.Handshake.Version (Accept (..),
                     Acceptable (..))
...
data NodeToClientVersion
    ...
    | NodeToClientV_3
    -- ^ enabled @BccNodeToClientVersion2@
    | NodeToClientV_4
    -- ^ enabled @BccNodeToClientVersion3@, adding more queries
    | NodeToClientV_5
    -- ^ enabled @BccNodeToClientVersion4@, i.e., Evie
    | NodeToClientV_6
    -- ^ enabled @BccNodeToClientVersion5@, i.e., Jen
    | NodeToClientV_7
    -- ^ enabled @BccNodeToClientVersion6@, adding a query
    | NodeToClientV_8
    -- ^ 'LocalStateQuery' protocol codec change, allows to acquire tip point.
    | NodeToClientV_9
    -- ^ enabled @BccNodeToClientVersion7@, i.e., Aurum
