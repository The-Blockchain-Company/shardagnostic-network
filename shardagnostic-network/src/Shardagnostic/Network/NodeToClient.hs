...
--
module Shardagnostic.Network.NodeToClient (
...
import           Shardagnostic.Network.Protocol.ChainSync.Client as ChainSync
import qualified Shardagnostic.Network.Protocol.LocalTxSubmission.Type   as LocalTxSubmission
import           Shardagnostic.Network.Protocol.LocalTxSubmission.Client as LocalTxSubmission
import qualified Shardagnostic.Network.Protocol.LocalStateQuery.Type   as LocalStateQuery
import           Shardagnostic.Network.Protocol.LocalStateQuery.Client as LocalStateQuery
...
import           Shardagnostic.Network.Subscription.Client ( ClientSubscriptionParams (..) )
import qualified Shardagnostic.Network.Subscription.Client as Subscription
import           Shardagnostic.Network.Subscription.Ip (SubscriptionTrace (..))
import           Shardagnostic.Network.Subscription.Worker (LocalAddresses (..))
...
-- | A specialised version of 'Shardagnostic.Network.Socket.connectToNode'.  It is
...
connectTo
  :: LocalSnocket
  -- ^ callback constructed by 'Shardagnostic.Network.IOManager.withIOManager'
...
--
-- Comments to 'Shardagnostic.Network.NodeToNode.withServer' apply here as well.
--
withServer
  :: LocalSnocket
