...
module Shardagnostic.Network.Protocol.ChainSync.Codec
  ( codecChainSync
  , codecChainSyncId
...
--
-- o So that a net running Optimum can better cope with streaks of empty slots.
--   (See @The-Blockchain-Company/shardagnostic-network#2245@.)
