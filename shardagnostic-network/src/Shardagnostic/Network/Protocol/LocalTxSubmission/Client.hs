...
--
module Shardagnostic.Network.Protocol.LocalTxSubmission.Client (
...
{-# DEPRECATED localTxSubmissionClientNull "Use Shardagnostic.Network.NodeToClient.localTxSubmissionPeerNull" #-}
