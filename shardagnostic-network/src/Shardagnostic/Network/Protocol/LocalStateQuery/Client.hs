...
module Shardagnostic.Network.Protocol.LocalStateQuery.Client (
...
import           Shardagnostic.Network.Protocol.LocalStateQuery.Codec (Some(..))
...
{-# DEPRECATED localStateQueryClientNull "Use Shardagnostic.Network.NodeToClient.localStateQueryPeerNull" #-}
