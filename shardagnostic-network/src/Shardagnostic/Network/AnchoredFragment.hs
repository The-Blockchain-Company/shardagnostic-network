...
module Shardagnostic.Network.AnchoredFragment (
...
import           Shardagnostic.Network.AnchoredSeq hiding (join, prettyPrint,
                     rollback)
import qualified Shardagnostic.Network.AnchoredSeq as AS
import           Shardagnostic.Network.Block
import           Shardagnostic.Network.Point (WithOrigin (At, Origin), withOrigin)
...
-- 'Shardagnostic.Network.MockChain.Chain' ('fromAnchoredFragment'), containing all
