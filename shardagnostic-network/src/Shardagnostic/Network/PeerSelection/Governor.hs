...
--
module Shardagnostic.Network.PeerSelection.Governor (
    -- * Design overview
    -- $overview
...
import qualified Shardagnostic.Network.PeerSelection.Governor.ActivePeers      as ActivePeers
import qualified Shardagnostic.Network.PeerSelection.Governor.EstablishedPeers as EstablishedPeers
import qualified Shardagnostic.Network.PeerSelection.Governor.KnownPeers       as KnownPeers
import qualified Shardagnostic.Network.PeerSelection.Governor.Monitor          as Monitor
import qualified Shardagnostic.Network.PeerSelection.Governor.RootPeers        as RootPeers
...
See the [Sophie delegation design specification, Sections 3.4.4 and 4.2](https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/delegationDesignSpec/latest/download-by-type/doc-pdf/delegation_design_spec).
