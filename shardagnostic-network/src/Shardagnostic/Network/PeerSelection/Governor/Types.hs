...
module Shardagnostic.Network.PeerSelection.Governor.Types
...
import           Shardagnostic.Network.PeerSelection.EstablishedPeers (EstablishedPeers)
import qualified Shardagnostic.Network.PeerSelection.KnownPeers as KnownPeers
import           Shardagnostic.Network.PeerSelection.KnownPeers (KnownPeers)
...
data Guarded m a =
    ...
    -- 'Shardagnostic.Newtork.PeerSelection.Governor.peerSelectionGovernorLoop' will
