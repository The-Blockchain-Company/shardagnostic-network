...
module Shardagnostic.Network.NodeToNode.Version
  ( NodeToNodeVersion (..)
...
data NodeToNodeVersion
    ...
    -- ^ Changes:
    --
    -- * Enable block size hints for Cole headers in ChainSync
    -- * Enable @BccNodeToNodeVersion2@, i.e., Sophie
    | NodeToNodeV_3
    -- ^ Changes:
    --
    ...
    -- * Enable @BccNodeToNodeVersion3@, i.e., Evie
    | NodeToNodeV_5
    -- ^ Changes:
    --
    -- * Enable @BccNodeToNodeVersion4@, i.e., Jen
    | NodeToNodeV_6
    -- ^ Changes:
    --
    ...
    --
    -- * new 'KeepAlive' codec
    -- * Enable @BccNodeToNodeVersion5@, i.e., Aurum
