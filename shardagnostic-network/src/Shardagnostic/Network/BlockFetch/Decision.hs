...
module Shardagnostic.Network.BlockFetch.Decision (
...
import           Shardagnostic.Network.BlockFetch.ClientState (FetchRequest (..),
...
data FetchMode =
     ...
     | FetchModeDeadline
       ...
       -- time to next block under optimum, with the distribution of latency of
...
the sense specified by the Shardagnostic algorithm. It is a fully verified chain
