...
module Shardagnostic.Network.Protocol.TipSample.Test where
...
import           Shardagnostic.Network.Protocol.TipSample.Type
import           Shardagnostic.Network.Protocol.TipSample.Client
import           Shardagnostic.Network.Protocol.TipSample.Server
import           Shardagnostic.Network.Protocol.TipSample.Direct
import           Shardagnostic.Network.Protocol.TipSample.Examples
import           Shardagnostic.Network.Protocol.TipSample.Codec

import           Test.Shardagnostic.Network.Testing.Utils (splits2, splits3)
...
tests :: TestTree
tests = testGroup "Shardagnostic.Network.Protocol.TipSampleProtocol"
