...
module Shardagnostic.Network.Protocol.KeepAlive.Test where
...
import           Shardagnostic.Network.Protocol.KeepAlive.Examples
import           Shardagnostic.Network.Protocol.KeepAlive.Direct

import Test.Shardagnostic.Network.Testing.Utils
...
tests :: TestTree
tests = testGroup "Shardagnostic.Network.Protocol.KeepAlive"
