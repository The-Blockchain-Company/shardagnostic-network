...
module Shardagnostic.Network.Protocol.TxSubmission2.Test (tests) where
...
import           Shardagnostic.Network.Codec hiding (prop_codec)
...
import           Shardagnostic.Network.Protocol.TxSubmission.Test hiding (tests)
