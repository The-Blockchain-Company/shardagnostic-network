...
module Test.Shardagnostic.Network.PeerSelection (tests) where
...
import           Shardagnostic.Network.PeerSelection.Governor hiding
                     (PeerSelectionState (..))
import qualified Shardagnostic.Network.PeerSelection.Governor as Governor
import qualified Shardagnostic.Network.PeerSelection.KnownPeers as KnownPeers
import qualified Shardagnostic.Network.PeerSelection.LocalRootPeers as LocalRootPeers
import           Shardagnostic.Network.PeerSelection.RootPeersDNS

import           Test.Shardagnostic.Network.PeerSelection.Instances
import qualified Test.Shardagnostic.Network.PeerSelection.LocalRootPeers
import           Test.Shardagnostic.Network.PeerSelection.MockEnvironment hiding (tests)
import qualified Test.Shardagnostic.Network.PeerSelection.MockEnvironment
...
tests :: TestTree
tests =
  testGroup "Shardagnostic.Network.PeerSelection"
  [ Test.Shardagnostic.Network.PeerSelection.LocalRootPeers.tests
  , Test.Shardagnostic.Network.PeerSelection.MockEnvironment.tests
