...
let
  src = haskell-nix.haskellLib.cleanGit {
    name = "shardagnostic-network-docs-src";
    src = ../.;
    subDir = "docs";
  };
  cddl-specs = ../shardagnostic-network/test-cddl/specs;
in
pkgs.runCommand "shardagnostic-network-docs"
{
  ...
  mkdir -p shardagnostic-network/test-cddl/specs
  cp ${cddl-specs}/*.cddl shardagnostic-network/test-cddl/specs
