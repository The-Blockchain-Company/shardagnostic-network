...
--
module Shardagnostic.Network.Socket (
...
import           Shardagnostic.Network.ConnectionId
import           Shardagnostic.Network.Codec hiding (encode, decode)
...
import           Shardagnostic.Network.Protocol.Handshake
...
import           Shardagnostic.Network.Snocket (Snocket)
import qualified Shardagnostic.Network.Snocket as Snocket
import           Shardagnostic.Network.Server.Socket ( AcceptedConnectionsLimit (..)
                                                 , AcceptConnectionsPolicyTrace (..)
                                                 )
import qualified Shardagnostic.Network.Server.Socket as Server
import           Shardagnostic.Network.Server.ConnectionTable


-- | Tracer used by 'connectToNode' (and derivatives, like
-- 'Shardagnostic.Network.NodeToNode.connectTo' or
-- 'Shardagnostic.Network.NodeToClient.connectTo).
--
