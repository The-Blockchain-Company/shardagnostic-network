...
module Shardagnostic.Network.Protocol.Handshake.Codec
  ( codecHandshake
...
import           Shardagnostic.Network.Protocol.Limits
...
-- is instatiated to 'NodeToNodeVersionData' in "Shardagnostic.Network.NodeToNode"
-- or to '()' in "Shardagnostic.Network.NodeToClient".
--
