...
module Shardagnostic.Consensus.Ledger.Abstract (
  ...
  , ledgerTipSlot
    -- * Re-exports
  , module Shardagnostic.Consensus.Ledger.Basics
  ) where
...
-- type before and after validation may be distinct (eg Aurum transactions),
