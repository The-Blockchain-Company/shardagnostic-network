module Shardagnostic.Consensus.Ledger.SupportsPeerSelection (
...
import           Shardagnostic.Network.PeerSelection.LedgerPeers
...
class LedgerSupportsPeerSelection blk where
  ...
  --
  -- For example, for Sophie, the relays that have been registered in the
