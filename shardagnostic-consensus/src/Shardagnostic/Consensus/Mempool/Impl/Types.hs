...
module Shardagnostic.Consensus.Mempool.Impl.Types (
    -- * Internal State
    InternalState (..)
  , initInternalState
  , isMempoolSize
...
import           Shardagnostic.Consensus.Mempool.TxSeq (TicketNo, TxSeq (..),
                     TxTicket (..))
import qualified Shardagnostic.Consensus.Mempool.TxSeq as TxSeq
...
tickLedgerState  cfg (ForgeInUnknownSlot st) =
  ...
  where
    ...
    -- <https://github.com/The-Blockchain-Company/shardagnostic-network/issues/1298>
