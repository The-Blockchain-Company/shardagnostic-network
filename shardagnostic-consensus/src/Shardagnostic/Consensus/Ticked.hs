...
module Shardagnostic.Consensus.Ticked (Ticked (..)) where
...
--
-- * Scheduled delegations might have been applied in Cole
-- * New leader schedule computed for Sophie
-- * Transition from Cole to Sophie activated in the hard fork combinator.
