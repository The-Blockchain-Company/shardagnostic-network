...
module Shardagnostic.Consensus.HardFork.Combinator.Embed.Binary (protocolInfoBinary) where
...
import           Shardagnostic.Consensus.Protocol.Abstract (protocolSecurityParam)
import           Shardagnostic.Consensus.TypeFamilyWrappers
import           Shardagnostic.Consensus.Util.Counting (exactlyTwo)
