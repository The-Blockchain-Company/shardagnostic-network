...
module Shardagnostic.Consensus.HardFork.Combinator.AcrossEras (
    -- * Value for /each/ era
    PerEraBlockConfig (..)
  , PerEraCodecConfig (..)
...
import           Shardagnostic.Consensus.Util (allEqual)
...
import           Shardagnostic.Consensus.HardFork.Combinator.Util.DerivingVia
...
data EraMismatch = EraMismatch {
      -- | Name of the era of the ledger ("Cole" or "Sophie").
      ledgerEraName :: !Text
