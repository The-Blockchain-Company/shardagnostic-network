...
module Shardagnostic.Consensus.MiniProtocol.ChainSync.Server (
    Tip
...
import           Shardagnostic.Network.Block (ChainUpdate (..), Serialised,
                     Tip (..))
import           Shardagnostic.Network.Protocol.ChainSync.Server

import           Shardagnostic.Consensus.Storage.ChainDB.API (ChainDB, Follower,
...
-- 'Shardagnostic.Network.Protocol.ChainSync.Examples.chainSyncServerExample' that
