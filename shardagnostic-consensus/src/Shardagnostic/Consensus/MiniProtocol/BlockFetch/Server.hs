...
module Shardagnostic.Consensus.MiniProtocol.BlockFetch.Server (
    blockFetchServer
    -- * Trace events
...
import           Shardagnostic.Network.NodeToNode.Version (NodeToNodeVersion)
...
-- 'Shardagnostic.Network.BlockFetch.Examples.mockBlockFetchServer1', but using
-- the 'ChainDB'.
blockFetchServer
    :: forall m blk.
       ( IOLike m
