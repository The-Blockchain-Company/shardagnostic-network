...
--
-- > import           Shardagnostic.Consensus.HeaderStateHistory (HeaderStateHistory)
-- > import qualified Shardagnostic.Consensus.HeaderStateHistory as HeaderStateHistory
module Shardagnostic.Consensus.HeaderStateHistory (
    HeaderStateHistory (..)
  , cast
  , current
  , rewind
...
import           Shardagnostic.Network.AnchoredSeq (AnchoredSeq (..))
...
import qualified Shardagnostic.Consensus.HeaderValidation as HeaderValidation
