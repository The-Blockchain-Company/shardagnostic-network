...
module Shardagnostic.Consensus.Protocol.PBFT (
    PBft
  , PBftCanBeLeader (..)
  , PBftFields (..)
  , PBftIsLeader (..)
...
import           Shardagnostic.Consensus.Protocol.PBFT.Crypto
...
-- | Permissive BFT
--
-- As defined in https://hydra.tbco.io/job/Bcc/bcc-ledger-specs/coleChainSpec/latest/download-by-type/doc-pdf/blockchain-spec
data PBft c
