...
-- duplicated.
module Shardagnostic.Consensus.Storage.VolatileDB.Impl (
...
import qualified Shardagnostic.Consensus.Util.MonadSTM.RAWLock as RAWLock
import           Shardagnostic.Consensus.Util.ResourceRegistry (allocateTemp,
                     runWithTempRegistry)

import           Shardagnostic.Consensus.Storage.Common (BlockComponent (..))
...
import           Shardagnostic.Consensus.Storage.VolatileDB.API
import           Shardagnostic.Consensus.Storage.VolatileDB.Impl.FileInfo (FileInfo)
import qualified Shardagnostic.Consensus.Storage.VolatileDB.Impl.FileInfo as FileInfo
import qualified Shardagnostic.Consensus.Storage.VolatileDB.Impl.Index as Index
import           Shardagnostic.Consensus.Storage.VolatileDB.Impl.Parser
import           Shardagnostic.Consensus.Storage.VolatileDB.Impl.State
import           Shardagnostic.Consensus.Storage.VolatileDB.Impl.Types
import           Shardagnostic.Consensus.Storage.VolatileDB.Impl.Util
