...
module Shardagnostic.Consensus.Storage.LedgerDB.InMemory (
    -- * LedgerDB proper
    LedgerDbCfg (..)
  , ledgerDbWithAnchor
    -- ** opaque
...
-- but that is disallowed by all currently known Shardagnostic protocols).
--
...
-- | Version 1: uses versioning ('Shardagnostic.Consensus.Util.Versioned') and only
