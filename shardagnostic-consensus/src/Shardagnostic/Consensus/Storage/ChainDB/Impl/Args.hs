...
module Shardagnostic.Consensus.Storage.ChainDB.Impl.Args (
    ChainDbArgs (..)
  , ChainDbSpecificArgs (..)
  , RelativeMountPoint (..)
  , defaultArgs
...
-- means (see the properties in "Test.Shardagnostic.Storage.ChainDB.GcSchedule"):
--
...
--   operation, we receive 1 block/20s (for Cole /and/ for Sophie), meaning
--   at most 4 blocks.
