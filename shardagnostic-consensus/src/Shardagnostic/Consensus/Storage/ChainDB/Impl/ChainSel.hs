...
-- adding a block.
module Shardagnostic.Consensus.Storage.ChainDB.Impl.ChainSel (
    addBlockAsync
  , addBlockSync
...
import           Shardagnostic.Consensus.Util.AnchoredFragment
import           Shardagnostic.Consensus.Util.IOLike
import           Shardagnostic.Consensus.Util.STM (WithFingerprint (..))

import           Shardagnostic.Consensus.Fragment.Diff (ChainDiff (..))
import qualified Shardagnostic.Consensus.Fragment.Diff as Diff
import           Shardagnostic.Consensus.Fragment.ValidatedDiff
                     (ValidatedChainDiff (..))
import qualified Shardagnostic.Consensus.Fragment.ValidatedDiff as ValidatedDiff
import           Shardagnostic.Consensus.Storage.ChainDB.API (AddBlockPromise (..),
                     BlockComponent (..), InvalidBlockReason (..))
import           Shardagnostic.Consensus.Storage.ChainDB.Impl.BlockCache
                     (BlockCache)
import qualified Shardagnostic.Consensus.Storage.ChainDB.Impl.BlockCache as BlockCache
import           Shardagnostic.Consensus.Storage.ChainDB.Impl.LgrDB (LedgerDB',
                     LgrDB)
import qualified Shardagnostic.Consensus.Storage.ChainDB.Impl.LgrDB as LgrDB
import           Shardagnostic.Consensus.Storage.ChainDB.Impl.Paths
                     (LookupBlockInfo)
import qualified Shardagnostic.Consensus.Storage.ChainDB.Impl.Paths as Paths
import qualified Shardagnostic.Consensus.Storage.ChainDB.Impl.Query as Query
import           Shardagnostic.Consensus.Storage.ChainDB.Impl.Types
import           Shardagnostic.Consensus.Storage.ImmutableDB (ImmutableDB)
import qualified Shardagnostic.Consensus.Storage.ImmutableDB as ImmutableDB
import           Shardagnostic.Consensus.Storage.VolatileDB (VolatileDB)
...
chainSelection chainSelEnv chainDiffs =
  ...
  where
    ...
    -- [Shardagnostic]
    --
    -- Shardagnostic says that when we are given an invalid chain by a peer, we
