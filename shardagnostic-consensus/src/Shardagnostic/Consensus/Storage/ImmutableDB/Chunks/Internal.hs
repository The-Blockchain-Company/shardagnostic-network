...
module Shardagnostic.Consensus.Storage.ImmutableDB.Chunks.Internal (
    ChunkInfo (..)
...
-- <https://github.com/The-Blockchain-Company/shardagnostic-network/issues/1754>
data ChunkInfo =
...
{-------------------------------------------------------------------------------
  ...
  import from "Shardagnostic.Consensus.Storage.ImmutableDB.Chunks.Layout" without
  worrying that it's making assumptions that it shouldn't. All bets are off for
  modules that import "Shardagnostic.Consensus.Storage.ImmutableDB.Chunks.Internal".
-------------------------------------------------------------------------------}
