...
module Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Types (
    -- * Misc types
    BlockOrEBB (..)
  , WithBlockSize (..)
  , isBlockOrEBB
...
import           Shardagnostic.Consensus.Util.CBOR (ReadIncrementalErr)

import           Shardagnostic.Consensus.Storage.ImmutableDB.API (Tip)
...
-- 'Shardagnostic.Consensus.Storage.ImmutableDB.API.ImmutableDB'.
--
-- The validation policy is used by
-- 'Shardagnostic.Consensus.Storage.ImmutableDB.Impl.openDB': the initial opening of
