...
module Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Validation (
    ValidateEnv (..)
  , validateAndReopen
...
import           Shardagnostic.Consensus.Block hiding (hashSize)
import           Shardagnostic.Consensus.Util (lastMaybe, whenJust)
import           Shardagnostic.Consensus.Util.IOLike
import           Shardagnostic.Consensus.Util.ResourceRegistry (ResourceRegistry,
                     WithTempRegistry)

import           Shardagnostic.Consensus.Storage.FS.API
import           Shardagnostic.Consensus.Storage.FS.API.Types

import           Shardagnostic.Consensus.Storage.ImmutableDB.API
import           Shardagnostic.Consensus.Storage.ImmutableDB.Chunks
import           Shardagnostic.Consensus.Storage.ImmutableDB.Chunks.Internal
                     (unChunkNo, unsafeEpochNoToChunkNo)
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index
                     (cachedIndex)
import qualified Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index as Index
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index.Primary
                     (PrimaryIndex, SecondaryOffset)
import qualified Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index.Primary as Primary
import qualified Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index.Secondary as Secondary
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Parser
                     (BlockSummary (..), parseChunkFile)
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.State
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Types
import           Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Util
import           Shardagnostic.Consensus.Storage.Serialisation (DecodeDisk (..),
                     HasBinaryBlockInfo (..))

-- | Bundle of arguments used most validation functions.
--
-- Note that we don't use "Shardagnostic.Consensus.Storage.ImmutableDB.Impl.Index"
...
--   remain identical because we chose the chunk size to be equal to the Cole
