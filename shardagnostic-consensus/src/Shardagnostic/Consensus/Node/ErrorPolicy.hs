...
module Shardagnostic.Consensus.Node.ErrorPolicy (consensusErrorPolicy) where
...
import           Shardagnostic.Consensus.Node.DbMarker (DbMarkerError)
...
consensusErrorPolicy pb = ErrorPolicies {
      ...
      -- instance of 'Exception' within shardagnostic-consensus.
      --
