...
module Shardagnostic.Consensus.Node.Tracers (
...
import           Shardagnostic.Network.BlockFetch (FetchDecision,
...
import           Shardagnostic.Consensus.Forecast (OutsideForecastRange)
...
data TraceForgeEvent blk
  ...
  = TraceStartLeadershipCheck SlotNo
    ...
    -- ImmutableDB.
    --
    -- See also <https://github.com/The-Blockchain-Company/shardagnostic-network/issues/1462>
