-- | Assorted utility functions for Sophie protocol integration.
--
-- In particular, various things we need for integration with the @delegation@
-- package from bcc-ledger-specs.
module Shardagnostic.Consensus.Sophie.Protocol.Util (
...
import           Shardagnostic.Consensus.HardFork.History.Util (addEpochs,
                     countSlots)
